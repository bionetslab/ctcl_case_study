...
if __name__ == '__main__':
    ...
    celltypes_=list(np.unique(p_values_cell_type_shuffled_labels['cell_type']))
    heterogeneity_measures=['entropy', 'homophily', 'egophily']
    conditions_=list(set(np.unique(p_values_cell_type_shuffled_labels.condition_1)).union(set(np.unique(p_values_cell_type_shuffled_labels.condition_2))))
        ...
        for heterogeneity_measure in heterogeneity_measures:
            ...
            for j in disease_combinations:
                ...
                for k in local_heterogeneity_measure:
                    if len(p_values_cell_type_shuffled_labels[p_values_cell_type_shuffled_labels['cell_type']==i][p_values_cell_type_shuffled_labels['condition_1']==j[0]][p_values_cell_type_shuffled_labels['condition_2']==j[1]][p_values_cell_type_shuffled_labels['score']==k]['p_value_adj'])==0:
                        data_=p_values_cell_type_shuffled_labels[p_values_cell_type_shuffled_labels['cell_type']==i][p_values_cell_type_shuffled_labels['condition_1']==j[1]][p_values_cell_type_shuffled_labels['condition_2']==j[0]][p_values_cell_type_shuffled_labels['score']==k]
                    else:
                        data_=p_values_cell_type_shuffled_labels[p_values_cell_type_shuffled_labels['cell_type']==i][p_values_cell_type_shuffled_labels['condition_1']==j[0]][p_values_cell_type_shuffled_labels['condition_2']==j[1]][p_values_cell_type_shuffled_labels['score']==k]
    ...
    pvalue_statistics.to_csv('../../results/pvalue_statistics_shuffled_labels.csv')
