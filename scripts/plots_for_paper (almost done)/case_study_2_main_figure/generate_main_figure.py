...
for celltype in celltypes_:
    ...
    if cnt==1:
        title_prefix='B. '
        suptitle='Neighborhood enrichment (Basal keratinocytes)'
    else:
        title_prefix=None
        suptitle=None
    ...
    _plot_bk_neighborhood_enrichment_(p_values_cell_type_squidpy_nhoodEnrichment, squidpy_nhoodEnrichment_results, data, celltype, conditions, radii, subplot_axis_id, title_prefix, suptitle)
...
_plot_bk_centrality_measures_(p_values_cell_type_squidpy_centralityScores, data, celltype, conditions, radii, scores, subplot_axis_id, title_prefix)
...
plt.savefig('caseStudy2_main_figure.pdf', format='pdf', bbox_inches='tight')
fig.tight_layout()
plt.show()
