    ...
    for filename in os.listdir('../../data'):
        ...
        if filename.endswith('.h5ad'):
            ...
            for graph_type in graph_types:
                ...
                B_df=pd.DataFrame(B, columns =list(G.nodes()))
                B_df.index=list(G.nodes())
                B_df.to_csv(os.path.join(f'../../results/modularity_matrices/{graph_type}', f'{filename_suffix_removed}.csv'))
