...
def _generate_violinplot_(data, categories, x_col_name, y_col_name, p_value, subplot_axis_id, legend_loc, title_prefix=None, plot_title='', pval_col1='condition_1', pval_col2='condition_2', xlabel='Condition', ylabel='y', order=None):
...
def _generate_histplot_(score, data, subplot_axis_id, hue, legend_loc, title_prefix=None, plot_title='', xlabel='Score', ylabel='Count'):
