...
if __name__ == '__main__':
    ...
    fig, axes = plt.subplot_mosaic(layout, figsize=(10,16))
    ...
    for filename in list_of_filenames:
        ...
        _generate_scatter_subplot_(prop_iodide, spatial_data_filtered_by_cell_type, 'y', 'x', 'celltype', subplot_axis_id, title, savefig_name, palette, ncol)
