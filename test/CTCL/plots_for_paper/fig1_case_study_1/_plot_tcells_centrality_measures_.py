...
def _plot_tcells_centrality_measures_(p_values_cell_type_squidpy_centralityScores, data, celltype, conditions, scores, subplot_axis_id, legend_loc=None, title_prefix=None, plot_title=None, title_loc=None, xlabel=None, ylabel=None):
    ...
    ax.set_yticklabels(xticks, size = 20) # size = 20
