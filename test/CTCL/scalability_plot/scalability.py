...
# ax.set_title(plot_title, loc=title_loc, fontsize=25) # fontsize=25, pad=20
# # ax.set_xlabel(xlabel, fontsize=25) # fontsize=25, labelpad=20
# ax.set_ylabel('Runtime, sample with few cells (sec)', fontsize=25, labelpad=5) # fontsize=25, labelpad=20
...
# ax.set_title(plot_title, loc=title_loc, fontsize=25) # fontsize=25, pad=20
# # ax.set_xlabel(xlabel, fontsize=25) # fontsize=25, labelpad=20
# ax.set_ylabel('Runtime, sample with many cells (sec)', fontsize=25, labelpad=5) # fontsize=25, labelpad=20
# ax.set_xlabel('Radius ($r$)', fontsize=25, labelpad=5)
