...
if __name__ == '__main__':
    p_values_global_shuffled_labels=[]
    p_values_cell_type_shuffled_labels=[]
    for i in range(100):
        print(i)
        p_values_global = {
            'condition_1': [],
        ...
        sample_results.condition =  sorted(list(sample_results.condition), key=lambda x: random.random())
        ...
        cell_results.condition =  sorted(list(cell_results.condition), key=lambda x: random.random())
        ...
        p_values_global_shuffled_labels.append(p_values_global)
        p_values_cell_type_shuffled_labels.append(p_values_cell_type)
    p_values_global_shuffled_labels=pd.concat(p_values_global_shuffled_labels, axis=0)
    p_values_cell_type_shuffled_labels=pd.concat(p_values_cell_type_shuffled_labels, axis=0)
    p_values_global_shuffled_labels.to_csv(os.path.join('results', 'p_values_global_shuffled_labels.csv'))
    p_values_cell_type_shuffled_labels.to_csv(os.path.join('results', 'p_values_cell_type_shuffled_labels.csv'))
